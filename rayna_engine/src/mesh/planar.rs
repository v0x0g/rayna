...
impl Plane {
    ...
    /// * `material`: Material to be used for the [MeshIntersection] in the case of an intersection
    ...
    #[inline(always)]
    pub fn intersect_bounded(&self, ray: &Ray, interval: &Interval<Number>) -> Option<MeshIntersection> {
